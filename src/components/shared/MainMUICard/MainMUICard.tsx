    ...
    <ThemeProvider theme={responsiveTheme}>
      ...
      >
        ...
        >
          ...
          <CardContent sx={{ p: "0", width: "70%" }}>
            <Box
              sx={{
                backgroundColor: props.cardColour,
                display: { xs: "flex", md: "none" },
              }}
            >
              <Typography variant={"body1"} lineHeight="1.2">
                {" "}
                {cutStringToLastWord(props.story?.content, 500)}{" "}
              </Typography>
            </Box>
            <Box
              sx={{
            ...
            >
              <Typography variant={"body1"} lineHeight="1.2">
                {" "}
                {cutStringToLastWord(props.story?.content, 700)}{" "}
              </Typography>
            </Box>
            <Box
              sx={{
            ...
            >
              <Typography variant={"body1"} lineHeight="1.2">
                {" "}
                {cutStringToLastWord(props.story?.content, 1000)}{" "}
              </Typography>
            </Box>
            <Box
              sx={{
            ...
            >
              <Typography variant={"body1"} lineHeight="1.2">
                {" "}
                {cutStringToLastWord(props.story?.content, 1400)}{" "}
              </Typography>
            </Box>
          </CardContent>
        </Box>
